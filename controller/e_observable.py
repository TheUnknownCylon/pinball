...
class Observable:
    ...
    observers directly. Instead, it stores the inform-request on an event queue.
    Some other game-logic (game engine) can then process the events all at once
    whenever required, allowing a smooth game experience.
    """
